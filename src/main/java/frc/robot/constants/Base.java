...
public class Base {
  ...
  public final double DRIVETRAIN_WHEELBASE_METERS = 10;
  public final double DRIVETRAIN_TRACKWIDTH_METERS = 5;

  public final double MAX_VELOCITY_METERS_PER_SECOND = 4.14528;
  ...
  public double ksVolts = 0.22;
  public double kvVoltSecondsPerMeter = 1.98;
  public double kaVoltSecondsSquaredPerMeter = 0.2;

  // Example value only - as above, this must be tuned for your drive!
  public double kPDriveVel = 8.5;
