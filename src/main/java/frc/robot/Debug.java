...
public class Debug {
  ...
  private static final ShuffleboardTab tab = Shuffleboard.getTab("robot-debug");
  private static final NetworkTable table = NetworkTableInstance.getDefault().getTable("Shuffleboard")
      .getSubTable("robot-debug");
  ...
  public static synchronized Sendable getData(String key) {
    ...
    if (data == null) {
      throw new IllegalArgumentException("Debug data does not exist: " + key);
    } else {
      return data;
    }
  }
